...
Также лекция показывает фундаментальное различие *OLTP vs OLAP хранилищ* — почему для транзакций используют PostgreSQL (строковое хранение), а для аналитики ClickHouse (колоночное).
